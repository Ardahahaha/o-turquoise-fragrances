        ...
        <div className="mx-auto max-w-6xl px-4 pb-10 pt-10 text-center sm:px-6 sm:pb-16 sm:pt-20">
          ...
          <Reveal delay={360}>
            <div className="mt-5 flex items-center justify-center gap-3 sm:mt-7">
              <Link
                to="/boutique"
                className="group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-full border border-white/40 bg-white/30 px-8 py-3.5 text-sm font-medium text-foreground shadow-[inset_0_1px_0_0_rgba(255,255,255,0.7),inset_0_-6px_12px_-6px_rgba(214,188,150,0.35),0_12px_34px_-10px_rgba(214,188,150,0.5)] backdrop-blur-xl backdrop-saturate-150 transition-all duration-500 hover:-translate-y-0.5 hover:border-white/60 hover:bg-white/40 hover:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9),inset_0_-8px_16px_-6px_rgba(214,188,150,0.5),0_22px_46px_-12px_rgba(214,188,150,0.6)] sm:px-10 sm:py-4 sm:text-base"
              >
                {/* Specular highlight */}
                ...
                {/* Beige glow underlay */}
                <span className="pointer-events-none absolute -inset-1 -z-10 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(214,188,150,0.5),transparent_70%)] opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-100" />
